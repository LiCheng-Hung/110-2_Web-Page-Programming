...
<?php
echo "<body bgcolor='#ECFFFF'>"
?>

<div style="text-align:center"><h1>墾丁三日遊報名表</h1></div>
...
<div style="margin:auto; border-radius: 7px; box-sizing: border-box; content: ''; color: #46A3FF; border: 2px solid #46A3FF;">
    ...
    <div style="text-align:left;background-color:#ffffff;padding:0.1em 0.4em;">
        <table width="100%">
        <tr><td>
        <form action="http://uukt.com.tw/schedular/3-day-tour" method="post">
        <table >
            <tr><td>姓名:</td><td><input type="text" name="Name" required></td></tr>
            <tr><td>Email:</td><td><input type="email" name="email" required></td></tr>
            <tr><td>電話:</td><td><input type="tel" name="tel" required></td></tr>
            <tr><td>性別:</td><td><input type="radio" name="gender" value="boy" checked="checked">男<input type="radio" name="gender" value="girl">女<input type="radio" name="gender" value="other">其他</td></tr>
            <tr><td>餐點:</td><td><input type="checkbox" name="food" value="meat" checked="checked">葷食<input type="checkbox" name="food" value="vegetarian">素食(蛋奶素)<input type="checkbox" name="food" value="Vegan">全素</td></tr>
